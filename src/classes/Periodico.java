...
public class Periodico extends Geral{
    ...
    public Periodico(int paginas, String ISSN, String tipo, String[] autor, String titulo, int edicao, String cidade, String editora, int ano, String CDU, int quantidade, String assunto, String palavra1, String palavra2, String tamanho, int id) {
