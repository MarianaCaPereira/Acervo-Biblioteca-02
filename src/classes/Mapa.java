...
public class Mapa extends Geral{
    ...
    public Mapa(int paginas, String[] autor, String titulo, int edicao, String cidade, String editora, int ano, String CDU, int quantidade, String assunto, String palavra1, String palavra2, String tamanho, int id) {
